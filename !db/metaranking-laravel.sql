...
--
-- Hôte : 127.0.0.1
-- Généré le : sam. 02 mars 2024 à 01:14
...
(1, 'like', '2024-02-28 03:27:04', '2024-02-28 03:27:04');
...
(2, 'miruko', '2024-02-28 02:58:47', '2024-02-29 16:50:33'),
(4, 'waifu', '2024-02-28 03:27:21', '2024-02-29 16:50:41');
...
--
-- Déchargement des données de la table `tag_assoc`
--

INSERT INTO `tag_assoc` (`id`, `tag1_id`, `tag2_id`, `created_at`, `updated_at`) VALUES
(1, 2, 4, '2024-02-28 03:38:56', '2024-02-28 03:38:56');
...
(1, 'Quezako', 'quezako35@gmail.com', NULL, '$2y$12$XbhGvpVoAaIok6Kfu8Jf5uSQD/scgfYJCkMFdvDsKQeSYS3vrsAw6', 'eFGDQjfj3sj9m3IrOU01F6zfOehj7WThbecnGK7ppXIgjiv4J4eMJ65DxyOy', '2024-02-28 03:23:00', '2024-02-28 03:23:00');
...
(1, 1, 1, 1, '2024-02-28 03:40:09', '2024-02-28 03:40:09');
...
--
-- AUTO_INCREMENT pour la table `tag_assoc`
--
ALTER TABLE `tag_assoc`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
